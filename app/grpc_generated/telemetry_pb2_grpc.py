...
from app.grpc_generated import telemetry_pb2 as telemetry__pb2
...
class TelemetryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamTelemetry = channel.unary_stream(
                '/wally.telemetry.TelemetryService/StreamTelemetry',
...
def add_TelemetryServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'wally.telemetry.TelemetryService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('wally.telemetry.TelemetryService', rpc_method_handlers)
